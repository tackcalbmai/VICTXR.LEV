  ...
  catrin: {
    ...
    content: {
      en: {
        ...
        title: 'CATRIN',
        subtitle: 'A premium digital fitting room for a bridal salon with a real point of view.',
      ...
      lv: {
        ...
        title: 'CATRIN',
        subtitle: 'Premium digitālā pielaikošana kāzu salonam ar savu raksturu.',
        location: 'Jelgava, Latvija',
        year: '2026',
        services: ['Stratēģija', 'Web dizains', 'Izstrāde', 'Daudzvalodu UX'],
        ...
        sections: [
          ...
          },
          {
            ...
            text: 'Fotogrāfijām un salona personīgajai attieksmei jau bija emocionāls svars. Pareizais solis bija noņemt vizuālo troksni, dot attēliem telpu un katru praktisko ceļu padarīt mierīgu un apzinātu.',
          },
          {
            label: 'Kas mainījās',
            title: 'Redakcionāls ritms, īsta lokalizācija un tiešs ceļš uz pierakstu.',
            text: 'Rezultātā tapusi pārdomāta kleitu izlase, skaidras pakalpojumu lapas, informācija par pielaikošanu, atsauksmes un kontaktu ceļi latviešu, angļu un krievu valodā. Katra valoda ir pilnvērtīgi indeksējama lapa.',
          },
          {
            label: 'Rezultāts',
            title: 'Viena vienota pieredze no pirmā iespaida līdz pierakstam.',
            text: 'CATRIN tagad ir pilnvērtīga daudzvalodu klātbūtne, kas izceļ premium vizuālo materiālu, atbild uz praktiskiem jautājumiem un ved apmeklētāju uz pielaikošanu, nezaudējot zīmola raksturu.',
          },
        ],
        resultNote: 'Bez izdomātiem cipariem. Rezultāts ir dzīvs, indeksējams un veidots ap reālo klienta ceļu.',
      },
    },
  },
  anelika: {
    ...
    content: {
      en: {
        ...
        title: 'ANELIKA',
        subtitle: 'A wide service business turned into a clear route from problem to enquiry.',
        location: 'Jelgava / all Latvia',
        year: '2026',
        ...
        sections: [
          ...
          },
          {
            ...
            text: 'ANELIKA can present a broad offer across Latvia while keeping every page focused on a real task, a clear next step and a consistent trust signal.',
          },
        ],
      ...
      lv: {
        ...
        year: '2026',
        services: ['Informācijas arhitektūra', 'Web dizains', 'Pieteikumu plūsma', 'Tehniskais SEO'],
        ...
        sections: [
          ...
          },
          {
            ...
            text: 'Mājaslapai ātri jāatpazīst šis darbs, jāparāda pārklājums un uzticamība, pēc tam jādod īsākais loģiskais ceļš uz zvanu vai detalizētu pieteikumu.',
          },
          {
            label: 'Kas mainījās',
            title: 'Modulāra pakalpojumu sistēma ar skaidru komerciālu mugurkaulu.',
            text: 'Atsevišķi pakalpojumu centri, papildu lapas, responsīvas pieteikumu formas un daudzvalodu saturs tagad strādā vienā vizuālā un tehniskā sistēmā. Strukturēti metadati un indeksējamas lapas dod meklētājiem tādu pašu skaidrību kā apmeklētājiem.',
          },
          {
            label: 'Rezultāts',
            title: 'Praktisks biznesa rīks, kas var augt, nepārvēršoties labirintā.',
            text: 'ANELIKA var parādīt plašu piedāvājumu visā Latvijā, vienlaikus saglabājot katru lapu fokusētu uz reālu uzdevumu, skaidru nākamo soli un konsekventu uzticības signālu.',
          },
        ],
        resultNote: 'Apzināti citāds nekā CATRIN: mazāk atmosfēras, vairāk orientācijas, pierādījumu un darbības.',
      },
    },
  },
};
