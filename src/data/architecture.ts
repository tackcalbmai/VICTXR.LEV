    ...
    options: [
      {
        ...
        text: 'There is no useful website yet, or the business has changed enough that the old foundation is irrelevant.',
      ...
      },
      {
        ...
        text: 'The current site has value, but something in its structure, design, performance or conversion path is holding it back.',
        subject: 'Website redesign — fix what exists',
      },
      {
        id: 'unsure',
        index: '03',
    ...
    options: [
      {
        id: 'zero',
        index: '01',
        title: 'Sākt no nulles',
        text: 'Noderīgas mājaslapas vēl nav, vai arī bizness ir mainījies tik ļoti, ka vecais pamats vairs nav aktuāls.',
      ...
      },
      {
        ...
        index: '02',
        title: 'Salabot esošo',
        text: 'Esošajā vietnē ir vērtība, bet struktūra, dizains, veiktspēja vai ceļš līdz darbībai bremzē rezultātu.',
        subject: 'Mājaslapas pārveide — salabot esošo',
      },
      {
        id: 'unsure',
        index: '03',
