...
export const multipageCopy = {
  ...
  lv: {
    work: {
      ...
      intro: 'Es neizveidoju vienu vizuālo stilu un nepārdodu to atkārtoti. Katrs projekts sākas ar to, kas konkrētajam biznesam patiesībā jāpadara skaidrāks, spēcīgāks vai vieglāk izdarāms.',
      proof: 'Divi pabeigti projekti. Divas apzināti atšķirīgas sistēmas.',
      projectLabel: 'Projekts',
      liveLabel: 'Atvērt mājaslapu',
    ...
    about: {
      ...
      seoDescription: 'XO WEB ir Victxr Lev neatkarīgs tīmekļa projekts, kura pamatā ir skaidra domāšana, atšķirīgs dizains un tehniski pabeigtas mājaslapas.',
      eyebrow: 'XO WEB / Victxr Lev',
      ...
      principles: [
        ...
        },
        {
          ...
          text: 'Responsivitāte, ielāde, piekļūstamība, metadati, lokalizācija un nestandarta situācijas ir daļa no dizaina. Premium iespaids pazūd tajā brīdī, kad mājaslapa sāk uzvesties slikti.',
        },
      ],
    ...
    services: {
      ...
      seoDescription: 'Mājaslapas no nulles, mājaslapu pārveide, pārdošanas lapas, daudzvalodu mājaslapas, tehniskais SEO un turpmāka izstrāde no XO WEB.',
      eyebrow: 'Pakalpojumi / 03',
      title: ['Kas tev', 'patiesībā', 'ir vajadzīgs?'],
      intro: 'Jauna mājaslapa ir viena iespējamā atbilde. Ar to nav jāsāk.',
      services: [
        {
          index: '01',
        ...
        },
        {
          ...
          result: 'Indeksējama struktūra, kanoniskās adreses un valodu signāli, metadati, veiktspēja, piekļūstamība un analītikas pamati.',
        },
        {
          index: '06',
      ...
      antiTitle: ['Dažreiz vajag', 'vienkāršāku risinājumu.'],
      ...
      serviceCta: 'Pārrunāt šo variantu',
